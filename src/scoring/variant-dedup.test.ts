...
describe('variant-dedup', () => {
  it('deduplicates multiple variants sharing same base URL, keeping highest bitrate', () => {
    const candidates: Candidate[] = [
      {
        url: 'https://cdn.example.com/master.m3u8/720p',
        headers: {},
        mediaType: 'hls',
        capturedAt: 1000,
        area: null,
      ...
      {
        url: 'https://cdn.example.com/master.m3u8/1080p',
        headers: {},
        mediaType: 'hls',
        capturedAt: 1005,
        area: null,
  ...
  it('does not touch mp4 files', () => {
    const candidates: Candidate[] = [
      {
        url: 'https://cdn.example.com/master.mp4/720p',
        headers: {},
        mediaType: 'mp4',
        capturedAt: 1000,
        area: null,
      ...
      {
        url: 'https://cdn.example.com/master.mp4/1080p',
        headers: {},
        mediaType: 'mp4',
        capturedAt: 1005,
        area: null,
